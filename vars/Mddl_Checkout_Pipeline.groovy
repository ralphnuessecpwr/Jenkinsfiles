...
def runComparison() {
        ...
        bmcAmiDb2SchemaChangeMigration(
            ...
            objtyp:         'TS', 
            ssid:           pipelineConfig.ispw.lifeCycle[ispwSourceLevel].ssid,
            objPart1C1:     mddlTaskContent.mddl[ispwSourceLevel].database, 
            objPart2C1:     mddlTaskContent.mddl[ispwSourceLevel].tablespace, 
            objPart3C1:     '', 
            location2:      pipelineConfig.ispw.lifeCycle[ispwTargetLevel].ssid,
            objPart1C2:     mddlTaskContent.mddl[ispwTargetLevel].database, 
            objPart2C2:     mddlTaskContent.mddl[ispwTargetLevel].tablespace, 
            objPart3C2:     '', 
            postbaseexec:   false, 
            postbasename:   '', 
            postbaseprof:   '', 
