...
def call(Map pipelineParams)
{
    ...
    def ccDdioOverrideDev       = "SALESSUP.${pipelineParams.ispwApplication}.${pipelineParams.ispwSrcLevel}.LOAD.SSD"
    def ccDdioOverrideQa        = "SALESSUP.${pipelineParams.ispwApplication}.${ispwTargetLevel}.LOAD.SSD"
    ...
    node
    {
        ...
        */ 
        stage("Retrieve Tests")
        {
            ...
            //Retrieve the Virtualized Tests from Github that match that ISPW Stream and Application
            ...
            //Retrieve the Non Virtualized Tests from Github that match that ISPW Stream and Application
            gitFullUrl = "${pipelineConfig.git.url}/${pipelineParams.gitProject}/${pipelineParams.ispwStream}_${pipelineParams.ispwApplication}${pipelineConfig.git.tttVtRepoExtension}"
