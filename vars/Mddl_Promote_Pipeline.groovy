...
def runComparison() {
        ...
        bmcAmiDb2SchemaChangeMigration(
            ...
            objtyp:         'TS', 
            ssid:           pipelineConfig.ispw.lifeCycle[db2SourceLevel].ssid,
            objPart1C1:     mddlTaskContent.mddl[db2SourceLevel].database, 
            objPart2C1:     mddlTaskContent.mddl[db2SourceLevel].tablespace, 
            objPart3C1:     '', 
            location2:      pipelineConfig.ispw.lifeCycle[db2TargetLevel].ssid,
            objPart1C2:     mddlTaskContent.mddl[db2TargetLevel].database, 
            objPart2C2:     mddlTaskContent.mddl[db2TargetLevel].tablespace, 
            objPart3C2:     '', 
            postbaseexec:   false, 
            postbasename:   '', 
            postbaseprof:   '', 
